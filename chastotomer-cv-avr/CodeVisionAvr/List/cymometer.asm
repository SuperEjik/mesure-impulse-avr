...
; 0003 0061 result = 16000000.0*(float)mesurImp/(float)baseImp;
	RCALL SUBOPT_0xB
	RCALL __CDF1U
	__GETD2N 0x4B742400
	RCALL __MULF12
	...
	__PUTDP1
; 0003 0062 
; 0003 0063 //выводим на дисплей частоту
; 0003 0064 LCD_Goto(7, 0);
	LDI  R26,LOW(135)
	RCALL _LCD_WriteCom
; 0003 0065 BCD_LongLcd(result, 8, 1);
	__GETD1S 0
	RCALL __PUTPARD1
	LDI  R30,LOW(8)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _BCD_LongLcd
; 0003 0066 //и дл€ отладки количество опорных и входных импульсов
; 0003 0067 LCD_Goto(8, 1);
	LDI  R26,LOW(200)
	RCALL _LCD_WriteCom
; 0003 0068 BCD_LongLcd(baseImp, 8, 0);
	RCALL SUBOPT_0xC
	RCALL __PUTPARD1
	LDI  R30,LOW(8)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _BCD_LongLcd
; 0003 0069 LCD_Goto(0, 1);
	LDI  R26,LOW(192)
	RCALL _LCD_WriteCom
; 0003 006A BCD_LongLcd(mesurImp, 7, 0);
	RCALL SUBOPT_0xB
	RCALL __PUTPARD1
	LDI  R30,LOW(7)
	ST   -Y,R30
	...
	RCALL _BCD_LongLcd
; 0003 006B 
; 0003 006C saveTimer01 = 0;
	LDI  R30,LOW(0)
	STS  _saveTimer01,R30
	STS  _saveTimer01+1,R30
; 0003 006D saveTimer02 = 0;
	STS  _saveTimer02,R30
	STS  _saveTimer02+1,R30
; 0003 006E saveTimer11 = 0;
	STS  _saveTimer11,R30
	STS  _saveTimer11+1,R30
; 0003 006F saveTimer12 = 0;
